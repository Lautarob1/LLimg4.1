...
public struct HelperClient2 {
    ...
    public func installHelperTool2(helperID: String, completionHandler: @escaping (Error?) -> Void) {
        do {
        ...
        self.uninstallHelperTool2(helperID: helperID) { _ in
    ...
    public func uninstallHelperTool2(helperID: String, completionHandler: @escaping (Error?) -> Void) {
        do {
    ...
    private func _installAndConnect<P: BuiltInCommands>(
        ...
        self.installHelperTool2(helperID: helperID) {
            if let error = $0 {
                errorHandler(error)
                return
            }
